...
class Partner(models.Model):
    ...
    class Meta:
        verbose_name = "Партнёр компании"
        verbose_name_plural = "Партнёры компании"
...
class CompanyMilestone(models.Model):
    ...
    class Meta:
        verbose_name = "История компании по годам"
...
class CompanyRequisites(models.Model):
    ...
    def __str__(self):
        return f"Requisites {self.created_at.strftime('%Y-%m-%d')}"
...
class CompanyCertificate(models.Model):
    ...
    def __str__(self):
        return f"Certificate {self.created_at.strftime('%Y-%m-%d')}"
...
class CompanyVideo(models.Model):
    ...
    description = models.TextField(blank=True, null=True, help_text="Video description")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
